...
description: Orchestrate Django feature implementation with architecture, coding, and review phases
---

# Task

You are orchestrating Django feature implementation for: $ARGUMENTS

## Workflow

This is a multi-agent workflow with clear separation of concerns:

1. **django-architect** - Designs Django architecture, creates plans (NO CODE, NO TESTS)
2. **django-implementer** - Writes Django code according to plan (NO TESTS)
...
Launch **django-implementer** agent to write Django code according to plan.
INSTEAD you CAN run multiple **django-implementer** agents in PARALLEL to solve INDEPENDENT plan PARTS in a quick way.
