...
@pytest.fixture
def user_repository(test_database: Database) -> UserRepository:
    """
...
async def test_creates_user( user_repository: UserRepository, test_database: Database
) -> None:
...
async def test_creates_user_with_all_fields( user_repository: UserRepository
) -> None:
...
async def test_gets_user_by_id(user_repository: UserRepository) -> None:
...
async def test_gets_user_by_id_returns_none_if_not_found( user_repository: UserRepository
) -> None:
...
async def test_updates_user(user_repository: UserRepository) -> None:
...
async def test_updates_user_partially( user_repository: UserRepository
) -> None:
...
async def test_update_raises_error_if_user_not_found( user_repository: UserRepository
) -> None:
...
async def test_update_with_no_changes_returns_existing( user_repository: UserRepository
) -> None:
...
async def test_creates_multiple_users( user_repository: UserRepository
) -> None:
...
async def test_updates_updated_at_timestamp( user_repository: UserRepository
) -> None:
